...
def dev_network_d(input_shape):
    ...
    intermediate = Dense(100, activation='relu',
                         kernel_regularizer=regularizers.l2(0.0001), name='hl1')(x_input)
    intermediate = Dense(50, activation='relu',
                         kernel_regularizer=regularizers.l2(0.0001), name='hl2')(intermediate)
    intermediate = Dense(25, activation='relu',
                         kernel_regularizer=regularizers.l2(0.0001), name='hl3')(intermediate)
...
def run_devnet(args):
    ...
    for nm in names:
        ...
        for i in np.arange(runs):
            ...
            model_name = os.path.join('/Users/roberto/DevNet-master copy 3/model/devnet_', model_filename)
            ...
            #model.fit(x_train, y_train, epochs=epochs, batch_size=batch_size, steps_per_epoch=nb_batch, verbose=1, callbacks=[checkpointer])
...
if __name__ == '__main__':
    ...
    parser.add_argument("--known_outliers", type=int, default=457,
    ...
    parser.add_argument("--input_path", type=str, default='/Users/roberto/DevNet-master copy 3/dataset/', help="the path of the data sets")
    ...
    parser.add_argument("--output", type=str,
                        default='/Users/roberto/DevNet-master copy 3/results/devnet_auc_performance_30outliers_0.02contrate_2depth_10runs.csv',
